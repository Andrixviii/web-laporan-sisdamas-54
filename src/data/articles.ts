...
export const articles: Article[] = [
  {
    id: '1',
    title: 'Langah awal: menjejak Desa Harumansari dengan semangat dan penuh harapan',
    excerpt: 'Hari pertama KKN di Desa Harumansari diawali dengan pemberangkatan dari kampus, pembersihan posko, dan koordinasi dengan masyarakat. Langkah awal ini menjadi fondasi semangat pengabdian dan kolaborasi antara mahasiswa dan warga desa.',
    content: `
      <p>
      Hari pertama kegiatan Kuliah Kerja Nyata (KKN) dimulai dengan semangat dan antusiasme tinggi. Seluruh peserta berkumpul di Kampus UIN Sunan Gunung Djati Bandung untuk melakukan pemberangkatan menuju lokasi KKN, yaitu Desa Harumansari. Suasana pagi terasa penuh harap dan kebersamaan. Perjalanan menuju 
      desa ditempuh dengan lancar dan menjadi momen awal yang mengikat semangat gotong royong seluruh peserta.
      </p>
      
      <p>Setibanya di Desa Harumansari, kegiatan dilanjutkan dengan pembersihan posko utama yang akan menjadi pusat kegiatan KKN selama beberapa minggu ke depan. Para peserta bersama-sama membersihkan area dalam dan luar posko, menyusun perlengkapan, serta menata ruang agar nyaman digunakan. Kegiatan ini menjadi ajang awal kekompakan tim sekaligus upaya menciptakan lingkungan yang bersih dan layak untuk beraktivitas.</p>

      <p>Setelah posko selesai dibersihkan, peserta KKN segera berkoordinasi dengan aparat desa dan masyarakat sekitar. Pertemuan awal ini menjadi ajang perkenalan serta menyampaikan maksud dan rencana kegiatan KKN ke depan. Sambutan hangat dari masyarakat Harumansari menambah semangat tim untuk berkontribusi secara nyata dalam membantu dan bersinergi dengan warga desa selama pelaksanaan program-program KKN.</p>
    `,
    author: {
      name: 'Fadila Rahman',
      avatar: 'https://ik.imagekit.io/kkn54harumansari/Lainnya/Penulis/Dila.jpg?updatedAt=1753797019686',
      bio: 'Komunikasi dan Penyiaran Islam'
    },
    category: 'Siklus 1',
    tags: ['Keberangkatan'],
  ...
  {
    id: '2',
    title: 'Resmi Dimulai: Kolaborasi dan Harapan dalam Pembukaan KKN di Desa Harumansari',
    excerpt: 'Pembukaan KKN di Desa Harumansari menandai dimulainya pengabdian mahasiswa secara resmi. Kegiatan ini dihadiri oleh aparat desa, DPL, dan seluruh peserta KKN, disertai arahan dan rapat perencanaan program kerja ke depan.',
    content: `
      <h3>PEMBUKAAN KKN SISDAMAS</h3>
      <p>
      Pembukaan Kuliah Kerja Nyata (KKM) di Aula Kantor Desa Harumansari menjadi momentum bersejarah yang dihadiri oleh ketiga kelompok KKN, aparat desa, dan Kepala Desa. Atmosfer formal namun hangat menandai dimulainya secara resmi kegiatan pengabdian masyarakat yang telah lama kami nantikan.
      Sambutan dari Kepala Desa memberikan perspektif lokal tentang harapan dan ekspektasi masyarakat terhadap kehadiran mahasiswa KKN. Beliau menekankan pentingnya kolaborasi dan saling belajar antara mahasiswa dan masyarakat untuk mencapai tujuan bersama.
      </p>
      
      <h3>KUNJUNGAN DAN ARAHAN DOSEN PEMBIMBING LAPANGAN</h3>
      <p>Kehadiran Dosen Pembimbing Lapangan (DPL), Dr. H. Uu Nurul Huda, S.Ag., M.H., memberikan bobot akademis sekaligus dukungan moral yang luar biasa. Dalam arahannya, beliau menekankan pentingnya integrasi antara teori yang dipelajari di kampus dengan praktik nyata di lapangan.
      “KKN bukan hanya tentang mengabdi, tetapi juga tentang belajar dari masyarakat,” ungkap beliau yang kemudian menjadi semangat kami selama bertugas. Arahan DPL juga mencakup aspek metodologi pengabdian, etika bermasyarakat, dan pentingnya dokumentasi kegiatan untuk pembelajaran berkelanjutan.
      </p>
      
      <h3>RAPAT EVALUASI DAN PERENCANAAN</h3>
      <p>Kegiatan dilanjutkan dengan rapat evaluasi dan perencanaan lanjutan yang dihadiri seluruh anggota kelompok. Diskusi ini membahas strategi detail untuk minggu-minggu mendatang, identifikasi potensi tantangan, dan penetapan mekanisme koordinasi internal yang efektif.</p>
      
    `,
    author: {
      name: "Indie Jannatulma'wa",
  ...
  {
    id: '3',
    title: 'Sinergi Awal Pengabdian: Observasi, Sosialisasi, dan Perencanaan Program KKN Desa Harumansari',
    excerpt: 'Hari kedua KKN di Desa Harumansari diisi dengan pembagian kelompok kerja, kunjungan ke sekolah untuk observasi pendidikan, serta sosialisasi ke RW 07–10 guna pemetaan potensi lokal. Kegiatan ditutup dengan pembacaan Yasin bersama dan briefing program kerja sebagai persiapan pelaksanaan kegiatan selanjutnya.',
    content: `
      <h3>BRIEFING PEMBAGIAN KELOMPOK KERJA</h3>
      <p>Hari dimulai dengan briefing komprehensif tentang pembagian kelompok kerja yang dipimpin langsung oleh ketua kelompok. Lima belas mahasiswa dibagi dalam sub-kelompok berdasarkan kompetensi dan focus area program kerja, memastikan efektivitas dan efisiensi dalam pelaksanaan tugas.</p>
      
      <h3>KUNJUNGAN KE SEKOLAH-SEKOLAH</h3>
      <p>Tim pendidikan melakukan kunjungan sistematis ke sekolah-sekolah di Desa Harumansari untuk observasi dan koordinasi program pendidikan. Pertemuan dengan kepala sekolah menghasilkan pemahaman mendalam tentang:
      - Kondisi infrastruktur pendidikan lokal
      - Tantangan pembelajaran yang dihadapi siswa dan guru
      - Kebutuhan dukungan eksternal untuk peningkatan kualitas pendidikan
      - Peluang kolaborasi dalam program literasi dan pengembangan metode pembelajaran
      </p>
      
      <h3>KUNJUNGAN KE RW 07, 08, 09, DAN 10</h3>
      <p>Sementara itu, tim lainnya melakukan kunjungan bertahap ke empat RW untuk sosialisasi kehadiran KKN dan identifikasi potensi masyarakat. Setiap kunjungan menghasilkan gambaran unik tentang karakteristik demografis, sosial ekonomi, dan kebutuhan spesifik setiap wilayah.
      RW 08 menunjukkan aktivitas keagamaan yang sangat aktif dengan tradisi pengajian rutin. RW 09 memiliki potensi pengembangan ekonomi kreatif yang menarik. Sementara RW 07 dan 10 masing-masing memiliki keunggulan dalam bidang pertanian dan keterampilan masyarakat.
      </p>
      
      <h3>PEMBACAAN YASIN BERSAMA</h3>
      <p>Kegiatan spiritual berupa pembacaan Yasin bersama di posko KKN menjadi moment refleksi dan penguatan ikatan tim. Aktivitas ini tidak hanya memberikan ketenangan spiritual, tetapi juga menjadi sarana evaluasi informal tentang pengalaman dan pembelajaran hari itu.</p>
  
      <h3>BRIEFING PROGRAM KERJA KOMPREHENSIF</h3>
      <p>Hari ditutup dengan briefing program kerja yang sangat detail, mencakup timeline pelaksanaan, pembagian tugas spesifik, mekanisme koordinasi dengan berbagai stakeholder, dan penetapan indikator keberhasilan untuk setiap program yang akan dilaksanakan.</p>
  ...
  {
    id: '4',
    title: 'Kolaborasi Sosial dan Keagamaan di RW 08 Kampung Sayuran',
    excerpt: 'Hari diisi dengan pengajian bersama warga RW 08, pemetaan sosial Kampung Sayuran, dan rembug warga dengan tokoh masyarakat. Kegiatan ini memperkuat integrasi sosial, mengidentifikasi potensi serta tantangan lokal, dan membangun komitmen bersama untuk program pengembangan masyarakat.',
    content: `
      <h3>PENGAJIAN RUTINAN BERSAMA WARGA RW 08</h3>
      <p>Partisipasi dalam pengajian rutinan bersama warga RW 08 di Mesjid Al-Mu’minun yang dimulai pukul 14.00 WIB menandai milestone penting dalam proses integrasi sosial. Kegiatan ini menunjukkan komitmen kami untuk tidak hanya hadir secara fisik, tetapi juga spiritual dalam kehidupan masyarakat.</p>
      <p>Antusiasme warga dalam menyambut kehadiran mahasiswa KKN dalam kegiatan keagamaan rutin mereka menunjukkan tingkat penerimaan yang luar biasa. Materi pengajian yang disampaikan oleh ustadz lokal memberikan insight berharga tentang nilai-nilai keagamaan yang mengakar kuat dalam masyarakat Harumansari.</p>
      
      <h3>PEMETAAN SOSIAL KAMPUNG SAYURAN</h3>
      <p>Setelah pengajian, kegiatan dilanjutkan dengan pemetaan sosial kondisi masyarakat Kampung Sayuran melalui observasi langsung dan wawancara informal dengan warga. Proses ini menghasilkan pemahaman mendalam tentang:
      </br>
      1. Struktur Sosial Ekonomi:
      </br>
      - Diversifikasi mata pencaharian dari pertanian tradisional hingga sektor informal</br>
      - Tingkat pendapatan dan pola konsumsi masyarakat</br>
      - Akses terhadap fasilitas kesehatan dan pendidikan</br>
      - Dinamika sosial antar kelompok masyarakat</br>
      2. Organisasi Kemasyarakatan:</br>

      - Efektivitas struktur RT/RW dalam pengelolaan masyarakat</br>
      - Peran aktif tokoh agama dan tokoh adat</br>
      - Keberadaan organisasi pemuda dan kelompok perempuan</br>
      - Mekanisme pengambilan keputusan komunal</br>

      3. Potensi dan Tantangan:</br>
      - Kekayaan sumber daya alam yang belum optimal dimanfaatkan</br>
      - Potensi pengembangan wisata berbasis masyarakat</br>
      - Keterbatasan akses teknologi dan informasi</br>
      - Peluang pengembangan ekonomi kreatif berbasis kearifan lokal

      </p>
      
      <h3>REMBUG WARGA DENGAN TOKOH MASYARAKAT DAN WARGA RW 08 </h3>
      <p>Puncak kegiatan hari ini adalah rembug warga yang dihadiri tokoh masyarakat dan warga RW 08. Forum ini bukan sekadar pertemuan formal, melainkan dialog konstruktif dua arah yang sangat produktif dan demokratis.
      Dalam diskusi yang berlangsung hangat dan terbuka, berbagai isu strategis terungkap:</br>
      1. Permasalahan yang Diidentifikasi:</br>
      - Kebutuhan peningkatan keterampilan masyarakat untuk diversifikasi ekonomi</br>
      - Tantangan akses pasar untuk produk-produk lokal</br>
      - Keterbatasan fasilitas infrastruktur pendukung aktivitas ekonomi</br>
      - Perlu penguatan capacity building untuk organisasi masyarakat</br>

      2. Kebutuhan yang Diartikulasikan:</br>

      - Program pelatihan keterampilan praktis yang marketable</br>
      - Pendampingan pengembangan usaha mikro dan kecil</br>
      - Peningkatan literasi digital untuk akses informasi dan pemasaran</br>
      - Penguatan program pendidikan anak dan remaja</br>

      Yang tidak kalah penting, antusiasme luar biasa dari warga untuk berpartisipasi aktif dalam program-program KKN memberikan optimisme tinggi bagi kesuksesan kegiatan. Komitmen warga untuk menyediakan waktu, tenaga, dan sumber daya lokal menunjukkan ownership yang kuat terhadap program pengembangan masyarakat.
      </p>
  ...
  {
    id: '5',
    title: 'Refleksi, Konsolidasi, dan Fiksasi Program: Menguatkan Arah Pengabdian KKN 54',
    excerpt: 'Kegiatan hari ini difokuskan pada evaluasi komprehensif tiap divisi, identifikasi pencapaian dan tantangan, serta rapat fiksasi program kerja. Hasilnya adalah perumusan solusi strategis, penetapan prioritas program berbasis urgensi dan dampak, serta mekanisme monitoring yang terukur guna memastikan efektivitas dan keberlanjutan pengabdian.',
    content: `
      <h3>EVALUASI KOMPREHENSIF SETIAP DIVISI</h3>
      <p>Evaluasi mendalam setiap divisi menjadi momentum refleksi yang sangat berharga untuk mengukur progress dan mengidentifikasi area improvement. Setiap divisi menyampaikan laporan komprehensif mencakup pencapaian, tantangan, dan lesson learned dari kegiatan beberapa hari pertama.
      Divisi Pendidikan melaporkan respons positif dari sekolah-sekolah dan identifikasi kebutuhan spesifik untuk program literasi dan peningkatan metode pembelajaran. Divisi Ekonomi menyampaikan potensi besar pengembangan UMKM dan kebutuhan akses permodalan. Divisi Kesehatan mengidentifikasi pentingnya program promotif dan preventif untuk peningkatan kesadaran kesehatan masyarakat.
      Divisi Keagamaan dan Sosial melaporkan tingkat integrasi yang sangat baik dengan masyarakat melalui partisipasi dalam kegiatan keagamaan rutin. Sementara Divisi Infrastruktur mengidentifikasi beberapa area yang membutuhkan perbaikan untuk mendukung aktivitas ekonomi dan sosial masyarakat.
      </p>
      
      <h3>IDENTIFIKASI PENCAPAIAN DAN TANTANGAN </h3>
      <p>
      1. Pencapaian Signifikan:</br>
      - Tingkat penerimaan masyarakat yang melampaui ekspektasi awal</br>
      - Establishment jaringan koordinasi yang solid dengan tokoh masyarakat</br>
      - Identifikasi potensi dan kebutuhan masyarakat yang komprehensif dan akurat</br>
      - Partisipasi aktif dalam kegiatan sosial keagamaan yang menunjukkan integrasi cultural yang berhasil</br>

      2. Tantangan yang Dihadapi:</br>
      - Koordinasi timing dengan jadwal kegiatan masyarakat yang sangat padat</br>
      - Adaptasi program dengan kondisi geografis dan infrastruktur yang beragam</br>
      - Optimalisasi sumber daya tim yang terbatas untuk coverage area yang luas</br>
      - Balancing ekspektasi masyarakat dengan kapasitas dan waktu yang tersedia</br>

      3. Solusi yang Dirumuskan:</br>
      - Fleksibilitas scheduling dengan pendekatan partisipatif melibatkan tokoh masyarakat</br>
      - Customization program sesuai karakteristik dan kebutuhan spesifik setiap RW</br>
      - Intensifikasi koordinasi internal dan pembagian tugas yang lebih efisien</br>
      - Manajemen ekspektasi melalui komunikasi transparan tentang scope dan timeline program
      </p>
      
      <h3>RAPAT FIKSASI PROGRAM KERJA</h3>
      <p>Rapat keseluruhan yang dihadiri seluruh anggota kelompok KKN 54 menghasilkan roadmap yang jelas dan terukur. Fiksasi program kerja, penetapan agenda kegiatan, dan penentuan penanggung jawab setiap program dilakukan dengan mempertimbangkan:
      </br>
      1. Prioritas Berdasarkan Urgency dan Impact:</br>
      - Program pendidikan anak dan literasi sebagai investasi jangka panjang</br>
      - Pengembangan ekonomi kreatif untuk immediate impact pada pendapatan masyarakat</br>
      - Program kesehatan preventif untuk peningkatan kualitas hidup</br>
      - Penguatan organisasi masyarakat untuk sustainability program</br>

      2. Alokasi Sumber Daya yang Optimal:</br>
      - Matching kompetensi mahasiswa dengan kebutuhan program spesifik</br>
      - Distribusi waktu yang proporsional untuk setiap program prioritas</br>
      - Utilizasi fasilitas dan sumber daya lokal yang tersedia</br>
      - Koordinasi dengan stakeholder eksternal untuk dukungan program</br>
      3. Mekanisme Monitoring dan Evaluasi:</br>
      - Penetapan indikator keberhasilan yang terukur untuk setiap program</br>
      - Jadwal evaluasi berkala mingguan untuk adjustment program</br>
      - Sistem dokumentasi yang sistematis untuk pembelajaran</br>
      - Feedback mechanism dari masyarakat untuk improvement berkelanjutan</p>
    `,
    author: {
    ...
    {
    id: '6',
    title: 'Kolaborasi dan Aksi Nyata: Pendidikan, Keagamaan, dan Sinergi Lintas Kelompok KKN',
    excerpt: 'Kegiatan mengajar, pengajian, dan koordinasi lintas kelompok memperkuat keterlibatan sosial serta menghasilkan program gabungan yang lebih luas, efisien, dan berdampak bagi masyarakat.',
    content: `
      <h3>KEGIATAN MENGAJAR DI MTS TJOKROAMINOTO </h3>
      <p>Sebagian anggota kelompok KKN melaksanakan kegiatan mengajar di MTs Tjokroaminoto sebagai implementasi konkret dari program pendidikan. Kegiatan ini memberikan variasi metode pembelajaran yang menyegarkan bagi siswa-siswi dan sekaligus menjadi ajang praktik langsung bagi mahasiswa untuk mengaplikasikan teori pendidikan yang dipelajari di kampus.
      Interaksi langsung dengan siswa menghasilkan pemahaman mendalam tentang karakteristik pembelajaran anak desa, tantangan motivasi belajar, dan potensi pengembangan bakat yang belum tergali optimal. Respons antusias siswa terhadap metode pembelajaran yang lebih interaktif dan kreatif menunjukkan potensi besar untuk pengembangan program pendidikan berkelanjutan.
      </p>
      
      <h3>PENGAJIAN RUTIN DI RW 09</h3>
      <p>
      Sementara itu, sebagian anggota lainnya menghadiri pengajian rutin yang diselenggarakan oleh warga RW 09. Konsistensi partisipasi dalam kegiatan keagamaan di berbagai RW menunjukkan komitmen untuk membangun relasi yang kuat dan menyeluruh dengan seluruh komunitas masyarakat Harumansari.
      Pengajian di RW 09 memiliki karakteristik yang berbeda dengan RW 08, memberikan insight tentang diversity dalam praktik keagamaan dan pendekatan dakwah yang disesuaikan dengan karakteristik masyarakat setempat. Partisipasi aktif dalam diskusi keagamaan menunjukkan apresiasi warga terhadap kontribusi intelektual mahasiswa.
      </p>
      
      <h3>RAPAT KOORDINASI LINTAS KELOMPOK</h3>
      <p>
      Momentum penting hari ini adalah rapat koordinasi bersama Koordinator Desa (Kordes), ketua kelompok 52, dan ketua kelompok 53 untuk membahas program kerja gabungan. Koordinasi lintas kelompok ini menghasilkan sinergi yang luar biasa dan membuka peluang untuk:
      </br>
      1. Efisiensi dan Efektivitas Sumber Daya:
      </br>
      - Penggabungan kekuatan ketiga kelompok untuk program-program besar yang membutuhkan resources significan</br>
      - Sharing expertise dan kompetensi unik setiap kelompok</br>
      - Koordinasi timing untuk menghindari overlapping activities dan memaksimalkan participation rate masyarakat</br>

      2. Ekspansi Jangkauan dan Dampak:</br>

      - Coverage program yang mencakup seluruh wilayah desa secara komprehensif</br>
      - Diversifikasi program yang memenuhi berbagai kebutuhan segmen masyarakat</br>
      - Amplifikasi impact melalui kolaborasi dan mutual reinforcement program</br>
      3. Knowledge dan Experience Sharing:</br>
      - Transfer best practices dan lesson learned antar kelompok</br>
      - Cross-fertilization ide-ide kreatif untuk inovasi program</br>
      - Collaborative problem solving untuk tantangan kompleks yang dihadapi

      Program kerja gabungan yang disepakati mencakup festival budaya lokal, program pelatihan keterampilan massal, dan kampanye kesehatan masyarakat yang terintegrasi.
      </p>
    `,
    author: {
      name: 'Acmad Haikal Azumardi Azra',
    ...
    `,
    author: {
      name: 'Faiz Ali Musyaffa',
      avatar: 'https://ik.imagekit.io/kkn54harumansari/Lainnya/Penulis/Faiz.jpg?updatedAt=1753805834201',
      bio: 'Ekonomi Syariah'
    },
    category: 'Siklus 1',
    tags: ['Sosialisasi'],
...

  {
    ...
    `,
    author: {
      name: 'Aam Wafi Azizah',
      avatar: 'https://ik.imagekit.io/kkn54harumansari/Lainnya/Penulis/IMG_0840.jpg?updatedAt=1754147177396',
      bio: 'Pendidikan Matematika'
    },
    category: 'Siklus 2',
    tags: ['Sosialisasi'],
